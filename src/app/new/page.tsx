...
function SmartListingNewPage() {
  ...
  const { token: sessionToken, loading: sessionLoading, authHeader } = useAdminSession('/new')
    ...
    <div className="min-h-screen bg-gray-50" suppressHydrationWarning>
      ...
      {isCopyMode && (
        <div style={{
          ...
          <button
            onClick={() => { setIsCopyMode(false); setCopySourceId(null); window.history.replaceState({}, '', '/new'); }}
            style={{
