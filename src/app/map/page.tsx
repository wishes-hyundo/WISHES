  ...
  useEffect(() => {
    ...
    if (window.kakao?.maps) {
      ...
      const timeout = setTimeout(() => {
        clearInterval(checkInterval);
        console.warn('카카오맵 SDK가 10초 이내에 로드되지 않았습니다. .env.local에 NEXT_PUBLIC_KAKAO_MAP_KEY를 설정하세요.');
