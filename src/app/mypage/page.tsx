...
import { Heart, Clock, User, LogOut, Building2, MapPin, Maximize, ArrowLeft, Loader2, Bell, Settings, Check, Save } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { useFavorites } from '@/contexts/FavoritesContext';
import { cn } from '@/lib/utils';
import Image from 'next/image';

type TabType = 'favorites' | 'recent' | 'profile' | 'alerts';
