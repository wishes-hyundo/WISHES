...
const faqCategories: FAQCategory[] = [
    ...
    items: [
      {
        ...
        answer: 'WISHES는 서울·경기 지역의 원룸, 투룸, 오피스텔, 아파트, 상가, 사무실 등 다양한 부동산 매물을 전문적으로 중개하는 종합부동산 서비스입니다. 온라인으로 매물 검색부터 상담 신청까지 편리하게 이용하실 수 있습니다.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '보증금은 안전한가요?',
        answer: '전세보증금 반환보증보험(HUG, SGI 등)에 가입하시메 집주인이 보�&�금을 돌려주지 못하는 상황에서도 보호받을 수 있습니다. WISHES에서는 안전한 거래를 위해 보증보험 가입을 적극 권장하고 있습니다.',
      },
      {
      ...
      },
      {
        ...
        answer: '주택 임대차의 경우 최소 계약기간은 2년이며 (주택임대차보호법), 상가의 경우 최소 1년입니다 (상가건물임대차보호법). 갱신 시에도 기존 조건으로 연장 요청이 가능합니다.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: '상가 임대의 경우 임대료에 부가가치세(10%)가 별도로 부과됩니다. 매물 정보에 "부가세별도" 또는 "부가세폨함"으로 표기되어 있으니 확인해 주세요. 세금계산서 발행 관련 사항도 계약 시 확인하시기 바랍니다.',
      },
      {
        question: '사무실을 구할 때 주의할 점은?',
        answer: '사무실 선택 시 주요 확인 사항은 다음과 같습니다: 1) 전용면적과 공용면적 비윢, 2) 관리비 포함 항목(전기, 냉난방, 수도 등), 3) 주차 가능 여부 및 추가 비용, 4) 인터넷/통신 인프라, 5) 건물 보안 및 출입 시스템, 6) 임대차 계약 조건(보증금, 기간, 원상복구 의무 등).',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: '"대출계산기" 메뉴에서 대출 금액, 이자율, 상환 기간을 입력하시면 월 상환금과 총 이자를 자동으로 계산해 드립니다. 원리금균등상환, 원금균등상환, 만기일시상환 등 다양한 상환 방식을 비교할 수 있습니다.',
      },
      {
    ...
    items: [
      {
        ...
        answer: '계약 전 반드시 확인하세요: 1) 등기부등본 확인(소유권, 근저당, 가압쮖e 등), 2) 건춪����장 확인(위반건축물 여부), 3) 임대인 신불 확인, 4) 전세보증금반화보증보험 가입 가능 여부, 5) 확정일자 및 전입신고. WISHES에서 안전거래를 위한 체크리스트를 제공해 드립니다.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: '매물을 내놓고 싸의데 어떻게 하나요?',
        answer: '"상담·매물접수" 페이지에서 "매물접수" 탭을 선택하시면 매물 등록 신청이 가능합니다. 매물 유형, 위치, 면적, 가격 등의 정보를 입력해 주시면 담당자가 확인 후 연락드립니다.',
      },
      {
        question: '영업 시간은 어떻게 되나요?',
        answer: 'WISHES는 평일 09:00~18:00, 토요일 10:00~15:00에 운영됩니다 (일요일 및 공휴일 휴무). 온라인 상담 신청은 24시간 가능하며, 영업시간 외 접수 건은 다음 영업일에 순차적으로 연락드립니다.',
      },
    ],
  },
];
