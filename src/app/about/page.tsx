        ...
        <section className="bg-white rounded-xl border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="aspect-[16/10] rounded-lg overflow-hidden border border-gray-200">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.8!2d126.9267!3d37.4845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357c9f4e7a2b0001%3A0x1!2z7ISc7Jq47Yq567OE7IucIOq0gOyVheq1rCDsi6DrprzroZw2NOq4uCAyMw!5e0!3m2!1sko!2skr!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
