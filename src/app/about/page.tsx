...
export const metadata: Metadata = {
    ...
    description: 'WISHES는 서울·경기 지역 전문 종합부동산입니다. 원룸, 투룸, 오피스텔, 아파트, 상가, 사무실 등 다양한 매물을 전문 공인중개사가 안전하게 중개합니다.',
    ...
    return (
        <div className="pt-16 min-h-screen">
            ...
            <div className="max-w-5xl mx-auto px-4 py-12 space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            },
                            {
                                icon: Users,
                                title: '전문 상담팀',
                                desc: '공인중개사 자격을 갖춤 전문 상담팀이 고객 맞춤형 서비스를 제공합니다.',
                            },
                            {
                                icon: Shield,
                                title: '안전한 거래',
                ...
                <section className="bg-white rounded-xl border border-gray-200 p-8">
                    <h2 className="text-xl font-bold text-wishes-primary mb-6 flex items-center gap-2">
                        <MapPin className="w-6 h-6" /> 오시는 길
                    </h2>
