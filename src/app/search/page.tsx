...
export default function SearchPortalPage() {
  ...
  useEffect(() => {
    ...
    const patches: Array<[string, string]> = [
      ...
      ['ws-ext-patch-v397-pagination', '/search/content-v397-pagination.js?v=20260515b-counts'],
      ...
      ['ws-ext-patch-v399-fetch-by-id', '/search/content-v399-fetch-by-id.js?v=20260515a'],
