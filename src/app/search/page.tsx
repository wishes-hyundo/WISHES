...
export default function SearchPortalPage() {
  ...
  useEffect(() => {
    ...
    const patches: Array<[string, string]> = [
      ...
      ['ws-ext-patch-v364-photo-mobile', '/search/content-v364-photo-mobile-ux.js?v=20260512a'],
      ['ws-ext-patch-v365-mobile-ui', '/search/content-v365-mobile-ui.js?v=20260512a'],
