...
export default function SearchPortalPage() {
  ...
  useEffect(() => {
    ...
    const patches: Array<[string, string]> = [
      ...
      ['ws-ext-patch-v316-rawfields-fill', '/search/content-v316-modal-rawfields-fill.js?v=20260429-dedup'],
      // v317 (2026-04-29): 카카오 기반 주변 시설 (지하철 + 버스정류장)
      ['ws-ext-patch-v317-nearby-poi', '/search/content-v317-nearby-poi.js?v=20260429-above'],
