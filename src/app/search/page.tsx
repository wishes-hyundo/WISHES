...
export default function SearchPortalPage() {
  ...
  useEffect(() => {
    ...
    // L-bldg-unit (2026-04-28): 건축물대장 전유부 (호실) 정보 표시
    ...
    if (!existingV306) {
      ...
      v306Script.src = '/search/content-v306-bldg-unit.js?v=20260429b';
    ...
    if (!existingV308) {
      ...
      v308Script.src = '/search/content-v308-roadview.js?v=20260429b';
