...
export default function SearchPortalPage() {
  ...
  useEffect(() => {
    ...
    const patches: Array<[string, string]> = [
      ...
      // [Step 36 cascade fix 2026-05-19] disabled — 4 MutationObserver
      ...
      // [Step 36 cascade fix 2026-05-19] disabled — 3 MutationObserver
      ...
      // [Step 36 cascade fix 2026-05-19] disabled — 2 MutationObserver
      ...
      // [Step 36 cascade fix 2026-05-19] disabled — 2 MutationObserver — road fallback
