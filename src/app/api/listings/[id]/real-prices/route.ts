...
const SALE_ENDPOINTS: Record<string, { url: string; label: string }> = {
  '아파트': {
    url: 'http://openapi.molit.go.kr:8081/OpenAPI_ToolInstall498/service/rest/RTMSDataSvcAptTradeDev/getRTMSDataSvcAptTradeDev',
    label: '아파트 매매',
  },
  '오피스텔': {
...
function getLawdCd(address: string, dong: string): string {
  ...
  const codes: Record<string, string> = {
    ...
    '봀천시': '41190', '안산시': '41270', '안양시': '41170', '남양주시': '41360',
  ...
  const dongToGu: Record<string, string> = {
    ...
    '서촌동': '송파구', '송파동': '송파구', '풍납동': '송파구', '삼전동': '송파구',
    ...
    '수색동': '은평구', '응암동': '은평구', '녹번동': '은평구', '봈광동': '은평구',
    '진관동': '은평구', '갈현동': '은평구',
