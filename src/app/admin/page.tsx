                ...
                {listings.slice(0, 4).map((item: Listing) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    ...
                    <span className={`text-xs px-2 py-1 rounded-full font-medium ${
                      ...
                      {item.status === 'active' ? '가용' : item.status === 'contracting' ? '계약중' : '완료'}
                    </span>
                  </div>
                ))}
              </div>
                ...
                {contacts.filter((c: Contact) => c.status !== 'completed').slice(0, 4).map((item: Contact) => (
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">{item.phone} · {item.listing_title || '일반 문의'}</p>
                    </div>��[��\�Ә[YO^�^^�L�KLH��[�YY�[�۝[YY][H	][K��]\�OOH	�[�[����	ؙ�\�YLL^\�YM�	��	ؙ�^Y[��LL^^Y[��M�	XO���][K��]\�OOH	�[�[����	�(";"&	��	�,�:�;)$I�B���[����]���
J_B��]���
H�
��\�Ә[YOH�^\�H^Yܘ^KM^X�[�\�KM�����;,�:�; �z��;'m;%�"�z��:�����
_B��]����]�
      </div>
    );
  }
