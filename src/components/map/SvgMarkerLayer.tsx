...
export default function SvgMarkerLayer(props: SvgMarkerLayerProps) {
  ...
  useEffect(() => {
    ...
    //     useEffect[listings] → render() → 같은 level → pan path 만 실행 →
    //     worker render 호출 X → 새 listings 가 commitItems 안 거쳐서 markers
    //     redraw 안 됨. 옛 markers 만 화면에 남고 transform 으로만 이동 = stuck 보임.
