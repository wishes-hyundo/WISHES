...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // PR-D2 (2026-04-30): CLAUDE.md "/listings 영구 폐기 → /map?listing=ID"
      //   영구 적용. SEO 인덱스 자동 마이그레이션 (검색엔진은 301 따라감).
      //   /map/page.tsx 의 generateMetadata 가 listing query 별 metadata 생성.
      {
  ...
  //   SWC 가 프로덕션 빌드 시 client 번들에서 consol